 ...
 $('#book_training').submit(function(){
	...
	if($('#book_sports').validationEngine({returnIsValid:true})){
		...
		return false;
		 ...
		 <form name="book_sports" id="book_sports" method="post" action="#">
         	<div class="form_row">
            	<span id="label"><span id="required">*</span>Sports you would like to book:</span>
                <span id="field">
                	<select name="sport_type" id="sport_type" class="validate[required]>
             ...
             <div class="form_row">
              ...
              <div class="form_row">
			   ...
			   <div class="form_row">
			   <div style="height:20px;padding-left: 229px; padding-top: 20px;">Please enter the correct captcha  code to proceed ahead! <br/></div>
    ...
    width: 135px;" class= validate[required]"/></div>
             </div>
