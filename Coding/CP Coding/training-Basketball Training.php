...
<body class="body">
    ...
    <div class="mainContent">
		<div class="content_inner">
        	...
        	<header><h2>Training</h2></header>
			<section class="service_dtl">
            <header class="service_title"><h2>Basketball Training</h2></header>
			<div style="float:right; width:100%; margin-left:15px;">
              <img src="images/trainings/baskerball_1396329234.jpg" alt="Basketball Training" />
			 
             <content class="service_dtl"><p>Looking to take your Basketball game to the next level? We, here at Bull&rsquo;s Club feature personal trainers who specialize in basketball conditioning workouts and trainings that will help you reach your peak performance on the basketball court. We offer specialized and sport-specific training playing court for Basketball. Our talented basketball instructors will teach you the fundamentals and strategy of basketball, as well as give you a great workout. Both beginners and advanced basketball players benefit from expert instruction. Players work on technique, coordination, balance, strength, toning, and cardio endurance. The timing for basketball training is set only in the evening as 4:00PM-8:00PM. The training session is limited for 1 hour daily, 6 days a week for a month long course.</p>
<p>&nbsp;</p></content>
			  <a class="submit_book" href="booking-Basketball%20Training.php"><img src="template/bulls_club/images/book_service.png"/></a>
			  </div>
            </section>
			 </article>
     	</div>
