    ...
    <div class="mainContent">
		<div class="content_inner">
			...
			<section class="service_dtl">
				<header class="service_title"><h2>Indoor Cricket</h2></header>
				<img src="images/services/indoor_cricket_1514781865.jpg" alt="Indoor Cricket" />
				<content class="service_dtl"><p>Indoor Cricket</p></content>
			</section>
		</article>
     	</div>
