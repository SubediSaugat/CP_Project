...
{
	$('div.success_error').show().php('<span style="color:#FFC600;">Loading...</span>');	  
$.ajax({
	   type: 'POST',
	   url:  _location,
	   data: _queryString,
	   success: function(msg){
		   	if(msg == 1){
			$('div.success_error').show().php('<span style="color:#FFC600;">Your request has been successfully sent.</span>');
			$('#book_training').each(function(){
               this.reset();  
            });
			}else if(msg==2){
				$('div.success_error').show().php('<span style="color:#F00;">Sorry your request couldn\'t be submitted!</span>'); 
			}else if(msg==3){
				$('div.success_error').show().php('<span style="color:#FFC600;">Your request has been successfully sent.</span>'); 
			...
			$('div.success_error').php('<span style="color:#F00;">Sorry</span>');
		}
	   }
	});
}
		...
		return false;
		 ...
		 <form name="book_training" id="book_training" method="post" action="#">
         	<div class="form_row">
                ...
                <span id="field"><input type="text" name="sport_type" id="sport_type" value="Badminton Training" readonly="readonly"></span>
              </div>
