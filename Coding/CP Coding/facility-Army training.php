    ...
    <div class="mainContent">
		<div class="content_inner">
			...
			<section class="service_dtl">
				<header class="service_title"><h2>Army Training</h2></header>
				<img src="images/services/desert_1471590872.jpg" alt="Army Training" />
				<content class="service_dtl"><p>Training of Army</p>
<p>&nbsp;</p></content>
			</section>
		</article>
     	</div>
